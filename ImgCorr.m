function [PD,ANNData]=ImgCorr(n,PD,ANNData,ImNames,RefStrat,StopCritVal)
	...
	for d=2:n, tic; % outer loop
		...
		if d==2, [PD,ANNData]=ANNDSS(PD,ANNData,SubExtract,ImNames,d,n); end % invoke ANNDSS to appoint appropriate subset sizes
