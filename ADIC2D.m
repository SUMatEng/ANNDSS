function [ProcData,ANNData]=ADIC2D(FileNames,Mask,GaussFilt,StepSize,SubSize,SubShape,SFOrder,RefStrat,StopCritVal,WorldCTs,ImgCTs,rho,ImageNoiseStd,ImageBitDepth,MaxSubSize)
	 ...
	 ANNData.ImageNoiseStd=ImageNoiseStd; ANNData.ImageBitDepth=ImageBitDepth; ANNData.MaxSubSize=MaxSubSize;
	 [ProcData,ANNData]=ImgCorr(n,ProcData,ANNData,FileNames,RefStrat,StopCritVal); % Section 3.2.1
