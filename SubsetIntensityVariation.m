function out=SubsetIntensityVariation(F) % needs 1 larger than subset in each direction (this is just basically subset entropy just without division to normalise it)
